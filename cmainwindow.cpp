...
void CMainWindow::slotArretPartie()
{
    ...
    {
        int reponse = QMessageBox::question ( this, NOM_PROG + " - Arrêter",
                                                    QString("   Arrêter la partie en cours ?   \n"),
                                                    "Continuer",	/// index 0
                                                    "Arrêter"		/// index 1
                                                    );
...
bool CMainWindow::testerSiPartieEnCours()
{
    if( true == m_pcrami->getEtatPartie())
    {
        QMessageBox::information( this, NOM_PROG + " - Jouer",
...
{
    int reponse = QMessageBox::question ( this, NOM_PROG + " - Quitter",
                                                QString("   Quitter le jeu Rami ?    \n\n"),
                                                "Continuer",	/// index 0
                                                "Quitter"	/// index 1
                                                );
...
void CMainWindow::closeEvent(QCloseEvent *event)
{
    ...
    afficherStatusBar();
    int reponse = QMessageBox::question(this, NOM_PROG + " - Fermer",
                                                QString("   Fermer le jeu Rami ?    \n\n"),
                                                "Annuler",	/// index 0
                                                "Fermer"	/// index 1
                                                );
...
{
    QSettings settings(ORGANISATION, "JNDQT5-" + NOM_PROG);
