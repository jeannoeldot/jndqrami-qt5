...
{
    quint16 hasard = 10 + (int) (1040.0*qrand()/(RAND_MAX+1.0));	/// de 10 a 1040
...
quint8 CRami::chercherCartePlusPetiteValeur( quint8 * ajeu, const bool a_pose, int & nbpaspose )
{
  ...
  {
    QMessageBox::information( this, NOM_PROG + " - Erreur",
                              QString(" ORDI JOUE\n\n"
                                        "carte == ERREUR_CARTE.\n\n"
                                        "Rami va QUITTER!!!\n\n"
                                        "DÉSOLÉ") );
...
void CRami::Ordi_Test_A_PrisCJetee( const quint8 *jeu )
{
    ...
    QMessageBox::information( this, NOM_PROG + " - Test",
                                QString(" ORDI"
                                "\n\n a pris carte jetée.\n") );
}
